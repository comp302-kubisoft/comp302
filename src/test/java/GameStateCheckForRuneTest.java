...
public class GameStateCheckForRuneTest {
  ...
  void testFindRuneInObject() {
    ...
    assertEquals(initialRunesFound + 1, gameState.getRunesFound(), "Should increment runesFound");
    assertEquals(
        3, gameState.getTileManager().mapTileNum[9][18], "Should change door tile to open (3)");
  }
  ...
  void testCheckEmptyLocation() {
    ...
    assertEquals(0, gameState.getRunesFound(), "Should not change runesFound");
    assertNotEquals(3, gameState.getTileManager().mapTileNum[9][18], "Should not change door tile");
  }
  ...
  void testCheckObjectWithoutRune() {
    ...
    assertEquals(initialRunesFound, gameState.getRunesFound(), "Should not change runesFound");
    assertEquals(
        initialDoorTile,
        gameState.getTileManager().mapTileNum[9][18],
