...
/**
 * Represents a generic game entity with basic properties such as position,
 * speed,
 * visual representation, and movement direction.
 */
public class Entity {
  ...
  /**
   * The current movement direction of the entity (e.g., "up", "down", "left",
   * "right").
   */
