...
public class Hero extends Entity {
  ...
  /** Sets the default values for the hero's position, speed, and initial direction. */
  ...
  /** Updates the hero's state based on user input, including position and direction. */
  public void update() {
    if (keyH.upPressed) {
      direction = "up";
