/**
 * Handles keyboard input events for the game. This class listens for keyboard events and updates
 * the InputState accordingly. Supports both WASD and arrow key controls.
 */
package ui.input;
...
public class KeyHandler implements KeyListener {
  ...
  /**
   * Handles key press events. Updates the input state when movement or action keys are pressed.
  ...
  /**
   * Handles key release events. Updates the input state when movement or action keys are released.
   * Supports both WASD and arrow keys for movement.
   *
