/**
 * Manages the loading and access of object images used in build mode.
 * This class is responsible for loading and storing all placeable object sprites,
 * providing a centralized way to access object images by their index.
 */
package ui.tile;
...
public class BuildObjectManager {
    ...
    /**
     * Loads all object images from their resource paths.
     * Called during initialization to populate the objectImages array.
     */
     ...
     * @return The BufferedImage for the specified object, or null if index is
     *         invalid
     */
